lambda_functions.zip: .env/lib/python2.7/site-packages scraper.py skill.py two_player_trueskill.py rankings.html.template
	rm -f lambda_functions.zip
	zip lambda_functions.zip scraper.py skill.py two_player_trueskill.py rankings.html.template
